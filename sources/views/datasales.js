	...
	config() {
		return {
			...
			columns:[
				...
				{ id:"id_penjualan", header:["id_penjualan", {content:"textFilter"} ], sort:"text" },
				{ id:"id_karyawan", header:["id_karyawan", {content:"textFilter"} ], sort:"text", fillspace:true, minWidth:150 },
				{ id:"id_cus", header:["id_customer", {content:"textFilter"} ], sort:"text" },
			...
			onClick:{
				"wxi-trash":(e, id) => {
					webix.confirm({
						text:"The sales will be deleted. <br/> Are you sure?",
